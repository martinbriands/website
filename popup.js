...
button.addEventListener("click", function () {
	...
	"Driving Simulator targeted towards aging home facilities patients suffering from dementia <br> Developped as a team of two developpers <br> Great number of iterations of the software, <br> with weekly review of new features <br> <br> The game presents an island to drive around, <br> with items randomly generated from a list to collect <br> and famous people and animals you can stop and talk to, the map is generated at loading from a double array <br> <br> The game works with physical modules (wheel, pedals ..) connected to a server that the game get its inputs from <br><br> What I implemented: <br> - Car Controller Input & Logic <br> - Collision Detection <br> - Interaction with characters <br> - Map Generation with customisation <br>",
...
button.addEventListener("click", function () {
	...
	"UofT Game Development & Design Club's<br> Game Making Deathmatch 2018 <br> 1st place Overall - 1st place Theme <br><br> Unity 2D action platformer <br> Developped with a team of 2 over 2 months <br> Players need to collect hats that stack, each hat having a different effect when you use it <br> <br> What I implemented: <br> - Character Movement and Physics <br> - Hat Interface Class for easy implementation of new Content <br> - Animation Rigging <br> - Area of sight with Raycasting <br>",
